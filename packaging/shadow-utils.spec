...
install -c -m 444 %SOURCE1 %{buildroot}/%{_sysconfdir}/
...
chmod u+s %{buildroot}/%{_bindir}/newgrp
chmod u+s %{buildroot}/%{_bindir}/chfn
chmod u+s %{buildroot}/%{_bindir}/chsh
chmod u+s %{buildroot}/%{_bindir}/gpasswd
chmod u+s %{buildroot}/%{_bindir}/passwd
chmod g+s %{buildroot}/%{_bindir}/chage
chmod g+s %{buildroot}/%{_bindir}/expiry
